...
public class Klus implements Serializable {
	...
	public boolean controleerManuren(int manuur) throws KlusAfvinkException {
		boolean b = true;
		if (manuur == 0) {
			throw new KlusAfvinkException("geen manuur ingevuld");
		}
		if (manuur > 9) {
			throw new KlusAfvinkException(
					"Langer dan 9 uur ingevuld dit mag niet");
		} else {
			b = true;
		}
		return b;
