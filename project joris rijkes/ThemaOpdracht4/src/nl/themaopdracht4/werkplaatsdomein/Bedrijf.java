...
public class Bedrijf implements Serializable {
	...
	public static ArrayList<Date> getAlleBeschikbareMonteursTijden(Monteur monteur, Calendar nweTijd) {
		return monteur.getAlleBeschikbareMonteursTijden(nweTijd);
	}
	...
	public ArrayList<Date> getAlleBeschikbareBedrijfTijden(Calendar nweTijd, ArrayList<Date> alleTijden)
			throws AfspraakMakenException {
		ArrayList<Date> alleTijdenDates = alleTijden;

		for (Monteur m : alleMonteurs) {
			ArrayList<Date> alleMonteurTijden = Bedrijf.getAlleBeschikbareMonteursTijden(m, nweTijd);
